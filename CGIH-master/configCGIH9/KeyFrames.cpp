...
void saveFrame(void)
{
	...
	KeyFrame[FrameIndex].rotHeadDog = rotHeadDog;
...
void resetElements(void)
{
	...
	rotHeadDog = KeyFrame[0].rotHeadDog;
}
void interpolation(void)
{
	...
	KeyFrame[playIndex].rotHeadDogInc = (KeyFrame[playIndex + 1].rotHeadDog - KeyFrame[playIndex].rotHeadDog) / i_max_steps;
...
int main()
{
	...
	for (int i = 0; i < MAX_FRAMES; i++)
	{
		...
		KeyFrame[i].rotHeadDog = 0;
		KeyFrame[i].rotHeadDogInc = 0;
	}
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::rotate(model, glm::radians(rotHeadDog), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
...
void Animation() {
	...
	if (play)
	{
		...
		else
		{
			...
			rotHeadDog += KeyFrame[playIndex].rotHeadDogInc;
			i_curr_steps++;
		}
