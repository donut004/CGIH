...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.ambient"), 0.3f,0.3f,0.3f); //(1ra ej, un cubo en blanco, es la fuente de luz)
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.diffuse"), 1.0f, 1.0f, 1.0f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.specular"), 1.0f, 1.0f, 1.0f);

        glUniform3f(glGetUniformLocation(lightingShader.Program, "light2.ambient"), 0.3f, 0.3f, 0.3f); //(1ra ej, un cubo en blanco, es la fuente de luz)
        ...
        //en reporte poner como cambia segun los valores en cada parametro
        ...
        // Set material properties (tambien esto agregamos)
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.ambient"), 0.0f, 0.9f, 0.1f);
