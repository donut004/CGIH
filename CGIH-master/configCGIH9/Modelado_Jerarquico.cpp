...
//For model
float	hombro = 0.0f, codo = 0.0f, muneca_z = 0.0f, muneca_x = 0.0f;
float d1 = 0.0f, f1 = 0.0f;
float d2 = 0.0f, f2 = 0.0f;
float d3 = 0.0f, f3 = 0.0f;
...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Model Bicep
		model = glm::rotate(model, glm::radians(hombro), glm::vec3(0.0f, 1.0, 0.0f)); //hombro
		...
		model = glm::rotate(model, glm::radians(muneca_x), glm::vec3(1.0f, 0.0, 0.0f));
		model = glm::rotate(model, glm::radians(muneca_z), glm::vec3(0.0f, 0.0, 1.0f));
		...
		model = glm::rotate(model, glm::radians(d1), glm::vec3(0.0f, 1.0, 0.0f));
		...
		model = glm::rotate(model, glm::radians(-f1), glm::vec3(0.0f, 1.0, 0.0f));
		...
		model = glm::rotate(model, glm::radians(-d2), glm::vec3(0.0f, 1.0, 0.0f));
		modelTemp2 = model = glm::translate(model, glm::vec3(0.3f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.6f, 0.2f, 0.2f));
		color = glm::vec3(0.0f, 0.0f, 1.0f); //azul
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		//dedo 2, falange2
		model = glm::translate(modelTemp2, glm::vec3(0.3f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(f2), glm::vec3(0.0f, 1.0, 0.0f));
		modelTemp2 = model = glm::translate(model, glm::vec3(0.2f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.4f, 0.2f, 0.2f));
		color = glm::vec3(1.0f, 0.0f, 0.0f); //rojo
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		modelTemp2 = modelTemp;
		model = glm::translate(modelTemp2, glm::vec3(0.25f,-0.3f, -0.4f));
		model = glm::rotate(model, glm::radians(-d3), glm::vec3(0.0f, 1.0, 0.0f));
		modelTemp2 = model = glm::translate(model, glm::vec3(0.3f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.6f, 0.2f, 0.2f));
		color = glm::vec3(0.0f, 0.0f, 1.0f); //azul
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		//dedo 3, falange2
		model = glm::translate(modelTemp2, glm::vec3(0.3f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(f3), glm::vec3(0.0f, 1.0, 0.0f));
		modelTemp2 = model = glm::translate(model, glm::vec3(0.2f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.4f, 0.2f, 0.2f));
		color = glm::vec3(1.0f, 0.0f, 0.0f); //rojo
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
