...
glm::vec3 lightPos2(-0.4f, 0.5f, 2.5f); //nueva luz en otra posicion
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Set lights properties (esto lo escribimos en lab)
 // Propiedades de la luz 1 (Ambiental muy alta)
        ...
        // Propiedades de la luz 2 (Ambiental muy alta)
        ...
        // Propiedades del material (Efecto radiactivo)
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.ambient"), 0.0f, 1.0f, 0.0f);  // Color verde emitido constantemente
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 0.2f, 0.2f, 0.2f);  // Casi no reacciona a la dirección de la luz
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.specular"), 0.1f, 0.1f, 0.1f); // Reflejo especular casi nulo
