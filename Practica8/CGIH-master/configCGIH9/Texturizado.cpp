...
int main()
{
	...
	//	0.5f, -0.5f, 0.0f,	   1.0f, 1.0f,1.0f,		1.0f,0.0f, //1.0,1.0 indicacion incorrecta
	...
	////Ejercicio 4, 3 ventanas largo 9 alto, en total 3x9
	//GLfloat vertices[] =
	//{
	//	// Positions            // Colors              // Texture Coords
	//	-0.5f, -0.5f, 0.0f,    1.0f, 1.0f,1.0f,		0.0f,0.0f,
	...
	//Ejercicio 5, 3 y 1/2 largo 5 ancho
	GLfloat vertices[] =
	{
		// Positions            // Colors              // Texture Coords
		-0.5f, -0.5f, 0.0f,    1.0f, 1.0f,1.0f,		0.0f,0.0f,
	...
	glBindTexture(GL_TEXTURE_2D, texture1);
	//EN GL_RGBA se activa el canal alfa, debido a que la nueva imagen tiene transparencia
	//PERO esto no es lo unico, luego se debe modificar el fragment shader y el de vertices
...
//ejercicios
//1. todo el cuadro cubrir ña textira 1.0, despues la 0,1 y despues 